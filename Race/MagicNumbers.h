#ifndef MAGICNUMBERS_CPP
#define MAGICNUMBERS_CPP
namespace magicNumbers {
	...
	static const int drawOfSpeedByX = 37;
	static const int drawOfSpeedByY = 6;
	...
	static const int endMoveOncomingCar = 20;
	...
	//field
	static const int borderLeftSide = 21;
	static const int borderRightSide = 29;
	static const int beginOfFieldByCoordinateY = 4;
	static const int endOfFieldByCoordinateY = 21;
	static const int beginOfFieldByCoordinateX = 20;
	static const int endOfFieldByCoordinateX = 31;
	static const int drawTopBorder = 4;
	static const int drawBottomBorder = 20;
	static const int drawLeftBorder = 20;
	static const int drawRightBorder = 30;
	static const char symbolForDrawBorder = '#';
	static const int drawBottomBorderScoreboard = 8;
	static const int drawRightBorderScoreboard = 39;
	static const int endOfScoreboardByCoordinateX = 40;
	static const int endScoreboardByCoordinateY = 9;

	//word SPEED:
	static const int drawWordSpeedByY = 6;
	static const int drawLetterSByX = 31;
	static const int drawLetterPByX = 32;
	static const int drawLetterEByX = 33;
	static const int drawLetterEEByX = 34;
	static const int drawLetterDByX = 35;
	static const int drawLetterDoublePointByX = 36;
}
#endif